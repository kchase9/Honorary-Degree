            ...
            <div class="content">
                ...
                <div class="other-actions">
                    <div class="btn-content">
                        <a href="https://uog.edu.gy/form/nomination-for-honorary-degree" class="btn" id="nom-btn">
                            Nominate a Recipient
                        </a>
                        <a href="guidelines.php" class="btn" id="nom-btn">
                            View Guidelines
                        </a>                      
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-8  col-sm-12 col-md-12">
                        ...
                        <p>
                        Every care should be taken to ensure the integrity of these awards while ensuring that
                        they are free from political, racial, economic and any other bias or any interference. 
                        </p>
                        <p>
