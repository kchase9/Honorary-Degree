...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="img/University-of-Guyana-Logo_Updated.png" type="image/png" />
    ...
    <header id="header" class="header" role="banner">
      <nav id="navbar-top" class="navbar">
        <div class="container container-md">
          ...
          <section class="form-inline navbar-form ms-auto">
            <nav role="navigation" aria-labelledby="block-secondarymenu-menu" id="block-secondarymenu" class="block block-menu navigation menu--menu-secondary-menu">
              ...
              <ul class="clearfix nav">
                <li class="nav-item">
                  <a href="https://uog.edu.gy/timetables" class="nav-link nav-link--timetables" data-drupal-link-system-path="timetables">Timetables</a>
                </li>
                <li class="nav-item">
                  <a href="https://uog.edu.gy/newsletter" class="nav-link nav-link--newsletter" data-drupal-link-system-path="newsletter">Latest News</a>
                </li>
                <li class="nav-item">
                  <a href="https://uog.edu.gy/documents" title="" class="nav-link nav-link--documents" data-drupal-link-system-path="documents">Resources</a>
                </li>
                <li class="nav-item">
                  <a href="https://uog.edu.gy/vacancies" class="nav-link nav-link--vacancies" data-drupal-link-system-path="node/152">Vacancies</a>
                </li>
                <li class="nav-item">
                  <a href="https://expertguide.uog.edu.gy" title="" class="nav-link nav-link-https--expertguideuogedugy">UG Experts</a>
                </li>
                <li class="nav-item">
                  <a href="https://uog.edu.gy/procurement" title="" class="nav-link nav-link--procurement" data-drupal-link-system-path="node/1521">Procurement</a>
                </li>
                <li class="nav-item">
                  <a href="https://uog.edu.gy/tactical-online-services" title="" class="nav-link nav-link--tactical-online-services" data-drupal-link-system-path="node/1117">TOS Unit</a>
                </li>
                <li class="nav-item">
                  <a href="https://uog.edu.gy/policies" class="nav-link nav-link--policies" data-drupal-link-system-path="policies">Policies</a>
                </li>
                ...
                <li aria-label="UG Map" class="nav-item">
                  <a href="https://uog.edu.gy/campus-map" class="nav-link nav-link--campus-map" data-drupal-link-system-path="node/737"><i class="fa fa-solid fa-location-dot" aria-hidden="true"></i></a>
                </li>
      ...
      <nav class="navbar navbar-expand-lg" id="navbar-main">
        <div class="container">
          <a href="https://uog.edu.gy" rel="home" class="navbar-brand">
            <img src="img/University-of-Guyana-Logo_Updated.png" alt="Home" class="img-fluid d-inline-block align-top">
          </a>
