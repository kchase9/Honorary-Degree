...
<body>
    ...
    <div id="content">
        <div id="page-heading">
            <h2 id="h-gal">Conferral of the Honorary Doctorate of Sports and Civic Engagement on Hon Dr Rohan Kanhai</h2>
            <hr>
        </div>

        <div class="video-container">
            <iframe 
                src="https://drive.google.com/file/d/1X0Hdr9etDFeZErSouE_9bAnPqnmEkGpc/preview" frameborder="0" 
