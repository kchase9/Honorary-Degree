...
<body>
    ...
    <div class="intro">
        <div class="">
            <div class="row w-100">
                <div class="col-md-6 main-pic" style="background-image: url('img/Univ_Baroness_Amos_by_John_Cairns_12.1.23-106 (1).jpg'); ">
            </div>
    ...
    <div class="content">
        ...
        <!--  Image Gallerie lery, adapted from Bootstrap -->
          <div class="row">
            <div class="col-lg-12">
                <div class="masonry-container">
                    <div class="masonry-item">
                        <img src="img/Univ_Baroness_Amos_by_John_Cairns_12.1.23-106 (1).jpg" class="img-fluid">
                    </div>
                    <div class="masonry-item">
                        <img src="img\Baroness Valerie Ann Amos.jpg" class="img-fluid">
                    </div>
                </div>
            </div>
          </div>      
