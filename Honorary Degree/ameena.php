...
<body>
    ...
    <div class="intro" >
        <div class="">
            <div class="row w-100">
                <div class="col-md-6 main-pic" style="background-image: url('img/Ameena Gafoor1.jpg');"></div>
                <div class="col-md-6 col-sm-12 ">
                    <div class="align-items-right bg-green" id="bio-preview">
                        <h1 class="p-3">Hon. Dr. Ameena Gafoor</h1>
    ...
    <div class="content">
        ...
        <div id="page-heading">
            <h2 id="h-gal">Highlights from the Robing of Hon Dr Ameena Gafoor</h2>
            <hr>
        </div>
            ...
            <div class="col-lg-12">
                <div class="masonry-container">
                    <div class="masonry-item">
                        <img src="img/Ameena Gafoor1.jpg" class="img-fluid">
                    </div>
                    <div class="masonry-item">
                        <img src="img/Ameena Gafoor2.jpg" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
